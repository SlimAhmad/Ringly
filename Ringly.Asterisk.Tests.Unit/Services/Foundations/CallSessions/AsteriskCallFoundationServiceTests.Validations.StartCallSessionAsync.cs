...
public partial class AsteriskCallFoundationServiceTests
{
    ...
    public async Task ShouldThrowValidationExceptionOnStartIfPartyAIsNullAndLogItAsync()
    {
        ...
        ValueTask<CallSession> startTask =
            this.callFoundationService.StartCallSessionAsync(nullPartyA, partyB);
    ...
    public async Task ShouldThrowValidationExceptionOnStartIfPartyBIsNullAndLogItAsync()
    {
        ...
        // when
        ValueTask<CallSession> startTask =
            this.callFoundationService.StartCallSessionAsync(partyA, nullPartyB);
        ...
        string? invalidExtension)
    {
        ...
        // when
        ValueTask<CallSession> startTask =
            this.callFoundationService.StartCallSessionAsync(invalidPartyA, partyB);
