...
{
    [Fact]
    public async Task ShouldThrowValidationExceptionOnRetrieveByUserIdIfUserIdIsInvalidAndLogItAsync()
    {
        // given
        ...
        Func<Task> retrieveTask = async () =>
            await this.telephonyIdentityService.RetrieveTelephonyIdentityByUserIdAsync(invalidUserId);
