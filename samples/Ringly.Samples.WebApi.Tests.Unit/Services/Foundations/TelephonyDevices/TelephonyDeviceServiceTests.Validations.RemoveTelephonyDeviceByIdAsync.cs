...
public partial class TelephonyDeviceServiceTests
{
    ...
    public async Task ShouldThrowValidationExceptionOnRemoveByIdIfIdIsInvalidAndLogItAsync()
    {
        ...
        Func<Task> removeTask = async () =>
            await this.telephonyDeviceService.RemoveTelephonyDeviceByIdAsync(invalidTelephonyDeviceId);

        // then
        TelephonyDeviceValidationException actualException =
            await Assert.ThrowsAsync<TelephonyDeviceValidationException>(removeTask);
    ...
    [Fact]
    public async Task ShouldThrowValidationExceptionOnRemoveByIdIfTelephonyDeviceNotFoundAndLogItAsync()
    {
        // given
