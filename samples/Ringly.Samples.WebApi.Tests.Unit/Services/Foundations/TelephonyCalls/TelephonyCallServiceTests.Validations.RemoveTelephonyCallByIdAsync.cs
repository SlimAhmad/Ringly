...
public partial class TelephonyCallServiceTests
{
    ...
    public async Task ShouldThrowValidationExceptionOnRemoveByIdIfIdIsInvalidAndLogItAsync()
    {
        ...
        Func<Task> removeTask = async () =>
            await this.telephonyCallService.RemoveTelephonyCallByIdAsync(invalidTelephonyCallId);

        // then
        TelephonyCallValidationException actualException =
            await Assert.ThrowsAsync<TelephonyCallValidationException>(removeTask);
    ...
    [Fact]
    public async Task ShouldThrowValidationExceptionOnRemoveByIdIfTelephonyCallNotFoundAndLogItAsync()
    {
        // given
